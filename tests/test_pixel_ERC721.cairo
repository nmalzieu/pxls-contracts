...
@view
func test_pixel_transfer_ownership{syscall_ptr: felt*, range_check_ptr, pedersen_ptr: HashBuiltin*}(
    ) {
    tempvar pixel_contract_address;
    %{ ids.pixel_contract_address = context.pixel_contract_address %}
    let (owner: felt) = IPixelERC721.owner(contract_address=pixel_contract_address);
...
@view
func test_pixel_erc721_max_supply{syscall_ptr: felt*, range_check_ptr, pedersen_ptr: HashBuiltin*}(
    ) {
    tempvar pixel_contract_address;
    %{ ids.pixel_contract_address = context.pixel_contract_address %}
